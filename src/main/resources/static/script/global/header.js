define(function(require, exports, module) {
    ...
    // 获取头像
    srvMap.add("getImgList", "global/retMessage.json", "sys/home/img");
    // 模板对象
    var Tpl = {
    ...
    var Query = {
        ...
        getHeaderImgInfo: function(){//获取头像
            var self = this;
            var img = Mod.header.find("[name='imgInfo']");
            Rose.ajax.getJson(srvMap.get('getImgList'), '', function(json) {
                img.attr("src","data:image/"+json.data[0]+";base64,"+json.data[1]);
            });
        },
